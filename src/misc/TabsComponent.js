...
const TabsComponent = ({index, region, countries, casesMillion, activeMillion, criticalMillion, deathsMillion, population, tests, colorsPie})  => {
            ...
            <Row>
                ...
                <Col className="px-0">
                    ...
                    <Row className="subtitle m-1 pt-1" >
                        ...
                        <Col className="box" style={{ color: "teal" }}>Active<div className="icon"><FontAwesomeIcon color="rgb(212, 23, 83)" icon={faArrowDown} /></div><h3>{(activeMillion[index] / deathsMillion[index] * 100).toFixed(0)}%</h3><div>/deaths</div></Col>
