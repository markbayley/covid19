...
const EuropeMenu = ({ state, toggleAsia, region, index, population, casesMillion,
 ...
 // Map Country Names
 const countryNames = countries.filter(country => country.continent === region).map(selectedCountry => selectedCountry.country.substring(0, 12))
